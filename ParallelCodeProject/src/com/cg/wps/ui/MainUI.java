...
public class MainUI {
	...
	public static void main(String[] args) {
		...
		String choice;
		while (true) {
			System.out.println("\n****Welcome to the Super cool payment Wallet App :: Capgeii Bank****");
			System.out.println("1. New User , lets Create New Account");
			System.out.println("2. Lets Enter the Super World :SignIn");
			choice = sc.next();
			try {
				if (bankSer.validateNumber(choice)) {
					...
					case 2:
						...
						break;
					default:
						System.out.println("!!! ohh Sorry, You Enter a Invalid one Please Enter a valid choice!!!");
						System.out.println("\n ~~Thank U~~");
					}
				}
	...
	private static void signIn() {
		...
		if (customer.getAccHolderName().equals(null)) {
			System.out.println(".Sorry again ..Invalid Credentials...");
			signIn();
		} else {
		...
		try {
			if (bankSer.validateNumber(choose)) {
				...
				case 1:
					...
					System.out
							.println("\n..Lucky day :).Transaction Successful...\n...Thank You  Visit Again...");
					customer = null;
					break;
				...
				case 2:
					System.out.println("... Rs. " + customer.getBalance()
							+ " ...");
					System.out
							.println("...Have A nice day :)Transaction Successful...\n...Thank You...");
					customer = null;
					break;
					...
					try {
						if (bankSer.validateEnteredAmount(depositAmount)) {
							bankSer.deposit(Integer.parseInt(depositAmount),
									customer);
							System.out
									.println("..wow:).Transaction Successful...\n...Thank You...");
						}
					} catch (TransactionException e) {
						// TODO Auto-generated catch block
						System.out.println(e.getMessage());
						System.out
								.println("..ohhhh!!!!.Unsuccessful Transaction...\n...Thank You...");
					}
					customer = null;
					break;
					...
					try {
						if (bankSer.validateWithdraw(withdrawAmount, customer)) {
							bankSer.withdraw(Integer.parseInt(withdrawAmount),
									customer);
							System.out
									.println(".Nice:)..Transaction Successful...\n...Thank You...");
						}
					} catch (TransactionException e) {
						// TODO Auto-generated catch block
						System.out.println(e.getMessage());
						System.out
								.println("..ohhh!!!.Unsuccessful Transaction...\n...Thank You...");
					}
					customer = null;
					break;
				...
				case 5:
					System.out
							.println("Enter accountId in where You want  to be transfered");
						...
						if (bankSer.validateNumber(choice)) {
							...
							while (limit > 0) {
								...
								if (password.equals(confirmPassword)) {
									...
									limit--;
									System.out
											.println("Nopeee!!!!!!Password and Confirm password not matched.\nEnter Again");
									if (limit >= 1) {
									} else {
										break;
									}
							...
							if (password == null) {
								...
								System.out
										.println("..Have a Nic day ....Account Successfully Created...\n"
